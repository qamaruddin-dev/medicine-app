      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Transform.scale(
                    scale: 1,
                    child: Consumer<WeekendProvider>(builder: (BuildContext context, value, Widget? child) {
                      return Checkbox(
            ...
            Consumer<WeekendProvider>(builder: (BuildContext context, value, Widget? child) {
